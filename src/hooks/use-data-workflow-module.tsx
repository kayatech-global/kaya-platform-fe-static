...
export const useDataWorkflowModule = () => {
    const [dataWorkflowModuleDataCardInfo] = useState<DashboardDataCardProps[]>(
    ...
    const onDataWorkflowModuleFilter = (filter: unknown) => {
        console.log(filter);
    };

    return {
        dataWorkflowModuleDataCardInfo,
        activityData,
        isFetching: false,
        bottomRef: ref,
