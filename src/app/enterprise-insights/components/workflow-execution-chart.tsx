...
import { WorkflowExecutionData, TopPerformer } from '../types/types';
...
import { Workflow, TrendingUp, TrendingDown, AlertCircle, RefreshCw } from 'lucide-react';
...
export const WorkflowExecutionChart: React.FC<WorkflowExecutionChartProps> = ({
    data,
    topPerformers,
    worstPerformers,
    isError,
        ...
        return (
            <div className="flex flex-col gap-y-4 p-6 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="flex flex-col items-center justify-center py-12 gap-y-4">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Failed to load workflow data</p>
                    <button
                        onClick={onRetry}
                    ...
                    {topPerformers.map((performer, index) => (
                        ...
                        >
                            <div className="flex items-center gap-x-3">
                                <span className="w-5 h-5 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-xs font-medium flex items-center justify-center">
                                    {index + 1}
                                </span>
                                <div>
