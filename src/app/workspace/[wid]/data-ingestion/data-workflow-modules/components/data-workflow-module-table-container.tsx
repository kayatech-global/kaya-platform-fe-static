...
export interface DataWorkflowModuleData {
    id: string;
...
interface DataWorkflowModuleTableContainerProps {
    dataWorkflowModules: DataWorkflowModuleData[];
    onDataWorkflowModuleFilter: (filter: IWorkflowExecutionFilters | null) => void;
}

const columns: ColumnDef<DataWorkflowModuleData>[] = [
    {
        enableSorting: true,
...
const DataWorkflowModuleFilter = ({
    onDataWorkflowModuleFilter,
}: {
    onDataWorkflowModuleFilter: (filter: IWorkflowExecutionFilters | null) => void;
}) => {
    const {
    ...
    const onHandleSubmit = (data: IWorkflowExecutionFilters) => {
        onDataWorkflowModuleFilter(data);
        setOpen(false);
    };
...
export const DataWorkflowModuleTableContainer = ({
    dataWorkflowModules,
    onDataWorkflowModuleFilter,
}: DataWorkflowModuleTableContainerProps) => {
    return (
        <div className="grid gap-8">
            <DataTable
                columns={columns}
                data={dataWorkflowModules}
                ...
                tableHeader={
                    <div className="flex justify-between items-center w-full">
                        <Input placeholder="Search Data Workflow Module" className="max-w-sm" />
                        <DataWorkflowModuleFilter onDataWorkflowModuleFilter={onDataWorkflowModuleFilter} />
                        <div className="flex ml-2">
                            <Button size={'sm'}>New Data Workflow Module</Button>
                        </div>
                    </div>
                }
            />
