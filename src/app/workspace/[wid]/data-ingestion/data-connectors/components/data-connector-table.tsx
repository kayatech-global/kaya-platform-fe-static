...
interface DataConnectorTableProps {
    data: TableDataType[];
    onDataConnectorFilter: (filter: IWorkflowExecutionFilters | null) => void;
}
...
const columns: ColumnDef<TableDataType>[] = [
    {
        ...
        cell: ({ row }) => {
            return <div>{row.getValue('connectionName')}</div>;
        },
    },
    {
        enableSorting: false,
    ...
    },
    {
        ...
        cell: ({ row }) => {
            return <div>{row.getValue('lastSync')}</div>;
        },
    },
    {
        enableSorting: false,
...
const DataConnectorTable = ({ data, onDataConnectorFilter }: DataConnectorTableProps) => {
    return (
            ...
            <DataTable
                ...
                tableHeader={
                    <div className="flex justify-between items-center w-full">
                        <Input placeholder="Search Data Connector" className="max-w-sm" />
                        <DataConnectorFilter onDataConnectorFilter={onDataConnectorFilter} />
                        <div className="flex ml-2">
                            <Button size={'sm'}>New Data Connector</Button>
                        </div>
                    </div>
                }
            />
