...
import { DatabaseConnectionData, DatabaseConnectionTableContainer } from './database-connection-table-container';
...
const mockTableData: DatabaseConnectionData[] = [
    {
        id: '01',
...
export const DatabaseConnectionContainer = () => {
    const { databaseConnectionDataCardInfo, activityData, bottomRef, onDatabaseConnectionFilter } =
        ...
        <React.Fragment>
            <div className="metric-page pb-4">
                <div className="flex justify-between gap-x-9">
                    ...
                    >
                        <DashboardDataCardList data={databaseConnectionDataCardInfo} />
                        ...
                        <DatabaseConnectionTableContainer
                            databaseConnections={mockTableData}
                            onDatabaseConnectionFilter={onDatabaseConnectionFilter}
                        />
                    </div>
                </div>
            </div>
