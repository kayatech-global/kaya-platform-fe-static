...
export const StandaloneAgentDetailContainer = () => {
    ...
    if (!agent) {
        return (
            <div className="metric-page flex flex-col items-center justify-center py-24 gap-4">
    ...
    return (
        <div className="metric-page pb-8">
            {/* Breadcrumb / Header */}
            <div className="dashboard-left-section flex flex-col gap-y-5">
